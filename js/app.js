    ...
    let rowTemplate = `
        <tr>
            ...
            <td class="table-number">
                <input class="billable" type="number" inputmode="decimal" pattern="[0-9]+([\,|\.][0-9])" step="0.1" min="0" max="730" oninput="inputTrim(this, 730)" placeholder="0">
            </td>
            <td class="table-number table-pro-bono">
                <input class="probono" type="number" inputmode="decimal" pattern="[0-9]+([\,|\.][0-9])" step="0.1" min="0" max="730" oninput="inputTrim(this, 703)" placeholder="0">
            </td>
